 ...
 return (
      <div className="bg-[#f9fafb] px-2 md:px-0 pt-0.5 md:pb-6">
       {/* Header Section */}
        ...
        <div className="flex flex-wrap justify-center gap-10 md:gap-7 mt-10">
          {provinceKohKong.map((p, index) => (
            <div
              key={index}
            ...
            >
              ...
              <div className="relative h-[260px] overflow-hidden">
                ...
                />
                <span className="absolute font-bold top-3 right-3 bg-white text-red-600 text-xs px-3 py-2 rounded-lg shadow">
                  {p.category}
                </span>
              </div>
