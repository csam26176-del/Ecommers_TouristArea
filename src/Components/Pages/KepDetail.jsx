...
const KepDetail = () => {
  ...
  const result = provincekep.find((p) => p.id === parseInt(id));
  ...
  return (
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      {/* 📩 CTA Section */}
      <div className="bg-gradient-to-b from-emerald-100 via-green-50 to-white text-center py-16 md:py-20 h-[28vh] md:h-[28vh] lg:h-[40vh]">
        ...
        <Link to="/contect">
          <button className="uppercase px-8 py-3 md:mt-8 bg-white text-yellow-700 font-semibold rounded-lg shadow hover:bg-gray-200 transition">
           book now
          </button>
        </Link>
      </div>
